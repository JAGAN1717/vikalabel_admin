      ...
      <div className="flex flex-1 pt-20">
        ...
        <aside id='sideAddnavbar' className="xl:w-76 bottom-0 hidden h-full w-64 overflow-y-auto bg-white shadow ltr:left-0 ltr:right-auto rtl:right-0 rtl:left-auto lg:block asside_menu">
          <div className="flex flex-col space-y-6 py-3">
           {classtext ? <a onClick={()=> handleSildebar2()} className='flex  justify-center sidebar-padding'><ArrowNext/></a> : <a onClick={()=> handleSildebar()} className='flex justify-end pe-5 sidebar-padding cursor-pointer'><ArrowPrev/></a> } 
            <SidebarItemMap />
          </div>
         </aside> 
        </div>
