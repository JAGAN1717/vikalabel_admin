    ...
    return isBrowser ? (
        ...
        <Card className="flex flex-col">
                <div className="flex flex-col items-center justify-between w-full md:flex-row  mb-5">
                    ...
                    <Button type='button' loading={isLoading} onClick={()=>postPrivacy()} >Upload</Button>
                </div>
        ...
        <Card className="flex flex-col">
                <div className="flex flex-col items-center justify-between w-full md:flex-row  mb-5">
                    ...
                    <Button type='button' loading={isLoading} onClick={()=>postShiiping()} >Upload</Button>
                </div>
            <div className='border'>
        ...
        <Card className="flex flex-col ">
                <div className="flex flex-col items-center justify-between w-full md:flex-row mb-5">
                    ...
                    <Button type='button' loading={isLoading} onClick={()=>postTermsCondition()} >Upload</Button>
                </div>
            <div className='border'>
        ...
        <Card className="flex flex-col">
                <div className="flex flex-col items-center justify-between w-full md:flex-row  mb-5">
                    ...
                    <Button type='button' loading={isLoading} onClick={()=>postAbout()} >Upload</Button>
                </div>
            <div className='border'>
